                ...
                components={
                    {
                        ...
                        h2: ({node, ...props}) =>(
                            <h2 className="bg-white w-fit flex self-center py-4 px-6 justify-center items-center text-coal text-xl my-4 rounded-lg shadow-lg" {...props}/>
                        ),
                        h3: ({node, ...props}) =>(
                            <h3 className="flex justify-center text-coal text-xl my-4" {...props}/>
                        ),
                        p: ({node, ...props}) =>(
                            <p className="indent-16 text-coal my-4 max-w-[1200px] self-center leading-[2rem]" {...props}/>
                        ),
                        img: ({node, ...props}) => {
                            const {src, alt} = props
                            return (
